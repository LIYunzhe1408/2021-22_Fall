...
if __name__ == "__main__":
    ...
    url_root = "http://apps.webofknowledge.com/full_record.do?product=UA&search_mode=GeneralSearch&qid=1&SID=6C7ifTHgOsXBrnzbE9q&doc="
    ...
    while(i<=cnt):
        ...
        paper_Dic_Info = pagesToDic.Start_Scarp(root=url_root, nums_page=doc_num, filename=filename, start_num=start_num)
        info_dict = paper_Dic_Info
